...
//		Na kraju programa ugasite pretrazivac.
		...
		for (int i = 0; i < 5; i++) {
			...
			driver.findElement(By.name("name")).sendKeys("Aleksandra");
			driver.findElement(By.name("department")).sendKeys("QA trainee");
			driver.findElement(By.name("phone")).sendKeys("4686811633141");
			driver.findElement(By.xpath("//*[contains(@class, 'table-bordered')]/tbody/tr[last()]/td[last()]/a"))
					.click();
			Thread.sleep(500);
		}
		driver.quit();
